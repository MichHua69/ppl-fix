                              ...
                              <tbody  id="table-body" class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                ...
                                @foreach ($aktor as $item)
                                    <tr data-id="{{ $item->id }}">
                                      ...
                                      <td class="text-center px-4 puskeswan-column">{{ $item->puskeswan->puskeswan ?? null }}</td>
                                      <td class="hidden idpuskeswan-column">{{ $item->puskeswan->id ?? null }}</td>
                                      ...
                                      <td class="py-4 px-4 text-center flex justify-center items-center gap-4">
                                        <a class="flex justify-center edit-icon" href="">
                                          ...
                                          <button type="button" class="hidden text center p-2 text-sm bg-blue-500 rounded-lg text-secondary font-bold reset-password"> Reset Password</button>
                                      </td>
                                    </tr>
                                @endforeach
                              </tbody>
            ...
            <div class="bg-white p-8 rounded shadow-lg w-1/3">
                ...
                <form id="formTambah" action="{{ route('dinas.editakundokter') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="password" name="password" placeholder="Masukkan Kata Sandi" class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm @error('password') border-red-500 @enderror">
                        @error('password')
