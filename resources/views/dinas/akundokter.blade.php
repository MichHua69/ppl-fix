      ...
      <div class="container px-6 py-10 mx-auto">
        <div class="container bg-secondary rounded-lg shadow-lg overflow-hidden h-[80vh] relative p-12">
          <div class="block">
            ...
            <div class="mx-auto w-full flex items-center gap-6">
              <div class="relative w-full">
                  ...
                  <button type="submit" class="absolute top-0 right-0 p-2.5 text-sm font-medium border-gray-300 h-full text-white bg-primary rounded-e-lg border hover:bg-primary-light . dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              ...
              <a class="inline-block text-center rounded rounded-lg py-2 text-xl font-bold uppercase leading-normal text-white shadow-dark-3 transition duration-150 ease-in-out bg-primary hover:bg-primary-light min-w-32" href="">Tambah</a>
            </div>
                  ...
                  <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                      <table class="w-full divide-y divide-gray-200 dark:divide-gray-700 shadow-lg">
                          ...
                          <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                              <tr>
                                  <td class="py-4 px-4 text-center">Icang</td>
                                  <td class="py-4 px-4 text-center">Icangg</td>
                                  <td class="py-4 px-4 text-center">Icang@gmail.com</td>
                                  <td class="py-4 px-4 text-center">Ambulu</td>
