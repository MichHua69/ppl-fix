            ...
            <div class="container px-6 py-10 mx-auto">
                <div class="container bg-white rounded-lg shadow-lg h-full min-h-[75vh] relative p-12 mb-16">
                    <div class="block">
                        ...
                        <form action="{{ route('dinas.storeeditartikel', ['id' => $artikel->id]) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="">
                                ...
                                <div class="flex justify-end mt-8">
                                    <div class="flex gap-5">
                                        <button type="button"
                                            ...
                                            type="button" onclick="window.location='{{route('dinas.lihatartikel',['id'=>$artikel->id])}}'"
