                        ...
                        <div class="col-span-2 p-6 grid border-l-2 w-full">
                            <div class="container h-full">
                                ...
                                <div class="container flex flex-row text-xl">
                                    ...
                                    <div class="flex flex-col px-7 py-5 basis-1/2">
                                        <div class="flex flex-col mb-8 w-full justify-between">
                                            <label class="basis-3/12 font-semibold" for="nama">PUSKESWAN</label>
                                            <p class="peer block w-full py-3 rounded-md" id="nama-p">{{$aktor->puskeswan->puskeswan}}</p>
                                            <div class="relative basis-9/12" data-twe-input-wrapper-init>
                                                <input type="text" name="nama" id="nama" placeholder="Masukkan Nama" class="hidden peer block w-full p-3 pl-4 border border-gray-300 rounded-md shadow-sm focus:outline:none focus:ring-primary focus:border-primary @error('nama') border-red-500 @enderror" value="{{$aktor->puskeswan->puskeswan}}" autocomplete="name" autofocus/>
                                                @error('nama')
                                                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                                @enderror
                                            </div>
