<nav class="flex items-center justify-between p-6 lg:px-8 bg-secondary shadow-xl z-40" aria-label="Global">
    ...
    <div class="flex flex-1 justify-end gap-2 items-center">
      <div class="flex justify-end h-full ">
        <div x-data="{ dropdownOpen: false }" class="relative" id="notif-icon">
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
      window.Echo.channel('my-channel')
          .listen('.notifikasi', (e) => {
              console.log(e.data);
              renderNotificationpusher(e.data.judul, e.data.isi, e.data.created_at);
          });
  });

  function renderNotificationpusher(judul, isi, createdAt) {
      ...
      notificationElement.className = "notification flex items-center px-4 py-3 border-b mx-1";
      ...
      timeElement.innerText = getTimeElapsed(createdAt);
  ...
  function renderNotifications(notifications) {
      ...
      if (Array.isArray(notifications) && notifications.length > 0) {
          notifications.forEach(notification => {
              ...
              const timeElement = document.createElement("p");
              timeElement.className = "text-right font-sm";
              timeElement.innerText = getTimeElapsed(notification.created_at); // Mengambil waktu notifikasi
          ...
          noNotificationElement.className = "notification no-notification flex items-center px-4 py-3 border-b mx-1";
  ...
  notifIcon.addEventListener('click', loadNotif);
</script>
